...
<xsl:value-of select="//script" disable-output-escaping="yes"/>
	...
	<td valign="top">
			...
			<iframe id="finalbuild" width="650" height="645"/>
...
<xsl:template name="writerow">
	...
	<tr>
			...
			<td>
				<input type="button" onclick="javascript:copyclip(this)" value="question{concat($pqnumber,$suffixno)}"/>  [<xsl:value-of select="$questiontype"/>]
