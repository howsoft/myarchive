...
sourceTree = "C:\Documents and Settings\hgd4\Desktop\Python Making OM Java 6"
...
for t in textfiles:
	...
	if qType == "drag1":
		xmlFromText = drag1.makeXmlFromText(textAsLines)
		
	if qType == "radio1":
		xmlFromText = radio1.makeXmlFromText(textAsLines)
...
for xmlfile in xmlfiles:
	...
	if ".xml" in xmlfile:
		...
		if questionType == "drag1":
			print "processing as drag1"
			drag1.process(filepath)
						
		if questionType == "radio1":
			print "processing as radio1"
			drag1.process(filepath)
