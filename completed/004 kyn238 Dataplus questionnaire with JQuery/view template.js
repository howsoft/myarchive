...
var HQ = jQuery.noConflict(true); /* now HQ is JQuery */
...
function show_defaultview(){
  ...
  current_user_oucu = HQ('#dp_username').val();
...
function get_table_html() {
  ...
  if(current_user_index === 999) {
    s += "<span style='color: red;'>You haven't added a record yet.</span>";
    return s;
  }
...
/*
  ...
  (when init() is triggered by HQ(document).ready()
   in header section)
